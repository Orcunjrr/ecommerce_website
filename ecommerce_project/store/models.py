...
class Product(models.Model):
    ...
    base_product = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, related_name='variants')
...
class SellRequest(models.Model):
    ...
    image = models.ImageField(upload_to='sell_requests/', blank=True, null=True)
